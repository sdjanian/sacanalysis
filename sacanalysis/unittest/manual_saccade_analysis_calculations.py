...
if __name__ == '__main__':
    ...
    scores["kurtosis_score"].iloc[0] =  kurtosis(four_saccades_correct_vector["vector"].iloc[0])
    scores["kurtosis_score"].iloc[1] =  kurtosis(four_saccades_correct_vector["vector"].iloc[1])
    scores["kurtosis_score"].iloc[2] =  kurtosis(four_saccades_correct_vector["vector"].iloc[2])
    scores["kurtosis_score"].iloc[3] =  kurtosis(four_saccades_correct_vector["vector"].iloc[3])

    scores["entropy_score"].iloc[0] =  entropy(four_saccades_correct_vector["vector"].iloc[0])
    scores["entropy_score"].iloc[1] =  entropy(four_saccades_correct_vector["vector"].iloc[1])
    scores["entropy_score"].iloc[2] =  entropy(four_saccades_correct_vector["vector"].iloc[2])
    scores["entropy_score"].iloc[3] =  entropy(four_saccades_correct_vector["vector"].iloc[3])
